package com.springBootExamples.kafka.config;


import com.springBootExamples.kafka.dto.KMessage;
...
public class KafkaConfiguration {
    @Value("${springBootExamples.kafka.address}")
    private String kafkaAddress;

    @Value("${springBootExamples.kafka.group.id}")
    ...
    //Veriyi tüketen
    @Bean
    public ConsumerFactory<? super String, ? super KMessage> consumerFactory() {
